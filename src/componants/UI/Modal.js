...
const Modal = ({ activeID, setShowModal }) => {
    ...
    return (
        <div className='w-full h-full fixed top-0 left-0 z-[1000001] bg-secondaryColor bg-opacity-40'>
            <div className="w-full md:max-w-[600px] md:w-full absolute top-1/2 left-1/2 z-20 bg-headingColor rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5 ">
                <div>
                    <figure>
